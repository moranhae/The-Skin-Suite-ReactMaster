            ...
            <div className="info">
              <div className="description">
                ...
                <p className="description">
                  <strong>HydraFacial MD is an industry-leading skin care system <br />
          ...
          <Col md="3">
            <div className="info">
              ...
              <h1>Peels</h1>
                ...
                <p><strong> A refreshing and vitalizing peel to leave skin fresh, clean, and smooth. </strong>
                <br /> $85
                </p>
                <h4 className="info-title">Red Carpet Ready</h4>
                <p> <strong> Beginning with a dermaplaning session, Red Carpet Ready leaves skin fully refreshed and ready for any special event. </strong>
              ...
              Unlike other types of light therapy, LEDs do not contain ultraviolet rays. Therefore, they’re safe for regular use.
                ...
                <p>
                 <strong> Your aesthetician will gently scrape the surface of your skin with a surgical scalpel, removing peach fuzz and dead skin cells. </strong>
                  <br /> An excellent form of physical exfoliation, Dermaplaning will leave your skin smooth and ready for any treatment or product. 
                  <br />
                  As an add-on $30 <br />
                  // a-la-carte $60
                </p>
